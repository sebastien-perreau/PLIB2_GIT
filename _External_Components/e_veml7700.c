...
*
*	Revision history	:
*		28/02/2019		- Initial release
* 
*********************************************************************/

#include "../PLIB2.h"

#warning "e_veml7700.c - I2C Frequency should be 400 KHz"

/*******************************************************************************
  Function:
    static void e_veml7700_handler(uint8_t id, IRQ_EVENT_TYPE evt_type, uint32_t data)
...
/*******************************************************************************
  ...
  Description:
    This routine is the main function for managing the VEML7700 driver. It
    should be placed in the 'main while loop' before or after the bus_management
    routine.
 
  Parameters:
    *var    - The VEML7700_CONFIG pointer variable
