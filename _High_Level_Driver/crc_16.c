...
// This is a reflected lookup table for CRC 16 bits with a polynomial value of 0x1021
static const uint16_t __crc16_tab_reflected_poly_0x1021[256] = 
{
...
// This is a reflected lookup table for CRC 16 bits with a polynomial value of 0x8005
...
static uint32_t __reflect_data(uint32_t data, uint8_t data_bit_length)
{
...
/*******************************************************************************
 * Function: 
 *      uint16_t crc_16_ibm_old(uint8_t *buffer, uint16_t length)
 * 
 * Description:
